...
class MusicFolderDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final songsAsync = ref.watch(songsInFolderProvider(path));
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => DetailHeaderActions.share(context, name),
          ),
          IconButton(
      ...
      body: songsAsync.whenOrFallback(
        data: (songs) {
          if (songs.isEmpty) {
            return Center(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(AppStrings.of(context).playAllCount(songs.length),
                            style: const TextStyle(
                              color: Colors.white,
                              fontSize: 14,
                              fontWeight: FontWeight.w600,
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return InkWell(
                      onTap: () {
                        ref.read(musicPlayingProvider.notifier).playQueue(songs, startIndex: i);
                        ref.read(musicPlaylistProvider.notifier).markPlayed(s.uri);
                        Navigator.of(context, rootNavigator: true)
                        .push(MaterialPageRoute(
                          builder: (_) => const MusicPlayerScreen(),
                        ));
        ...
        error: (_, __) => Center(
          child:
              Text(AppStrings.of(context).errorWord, style: const TextStyle(color: Colors.white54)),
        ),
      ),
    );
  }
