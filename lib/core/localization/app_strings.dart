...
class AppStrings {
  ...
  static const Map<String, String> _en = <String, String>{
    ...
    'vhPaywallFinePrint': 'Renews automatically. Cancel any time from Settings.',
  ...
  static const Map<String, String> _my = <String, String>{
    ...
    'vhPaywallFinePrint': 'အလိုအလျောက် သက်တမ်းတိုးသည်။ Settings မှ အချိန်မရွေး ရပ်နိုင်သည်။',
  ...
  static const Map<String, String> _th = <String, String>{
    ...
    'vhPlanMonthlyPrice': 'MMK 3,500',
    'vhPaywallFinePrint': 'ต่ออายุอัตโนมัติ ยกเลิกได้ทุกเมื่อในการตั้งค่า',
